...
const ProductionForm = ({ formData, handleInputChange }: CalculatorFormProps) => {
    const { t } = useLanguage();
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                        <Checkbox id="cost-accounting" onCheckedChange={(checked) => handleInputChange("hasCostAccounting", checked)} />
                        <Label htmlFor="cost-accounting">{t("calculator.form.costAccounting")}</Label>
                    </div>
                </div>
            </div>
        </div>
