...
const RetailForm = ({ formData, handleInputChange }: CalculatorFormProps) => {
    const { t } = useLanguage();
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    <Label>{t("calculator.form.retailPoints")}</Label>
                    <Input type="number" min="0" onChange={(e) => handleInputChange("retailPoints", e.target.value)} />
                </div>
            </div>
